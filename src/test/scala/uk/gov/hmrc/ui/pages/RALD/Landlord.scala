...
import uk.gov.hmrc.ui.pages.PropertyLinking.ManualAddressPage.headerCheck
import uk.gov.hmrc.ui.pages.RALD.WhatTypeOfAgreement.{click, continueButton, getElementById}
