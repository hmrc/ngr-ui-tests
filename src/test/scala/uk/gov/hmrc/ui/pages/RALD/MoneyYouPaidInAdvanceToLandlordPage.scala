...
object MoneyYouPaidInAdvanceToLandlordPage extends BasePage {

  def moneyYouPaidInAdvanceToLandlord(): Unit =
    headerCheck("Money you paid in advance to the landlord")

  def moneyYouPaidInAdvanceToLandlordAmountInput(amount: String): Unit =
    sendKeys(By.id("advanceMoney"), amount)
