...
object DidYouPayAnyMoneyToLandlordPage extends BasePage {
  ...
  def yesRadio(): Unit =
    click(getElementById("didYouPayAnyMoneyToLandlord-radio-value"))

  def noRadio(): Unit =
    click(getElementById("didYouPayAnyMoneyToLandlord-radio-value-2"))
