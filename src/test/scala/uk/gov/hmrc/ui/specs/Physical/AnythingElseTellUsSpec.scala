...
import uk.gov.hmrc.ui.pages.Physical.{AnythingElseTellUs, CheckAndConfirmChangesToInternalFeatures, HaveYouChangedExternalFeatures, HaveYouChangedInternalFeatures, HaveYouChangedUseOfSpace, HowMuchOfPropertyHasAirConditioning, InformationAndSupportingDocumentsNeed, SelectYourProperty, TellUsChangedPropertyFeaturesOrUseOfSpace, WhenCompleteChange, WhichInternalFeatureHaveChanged, SupportingDocuments}
